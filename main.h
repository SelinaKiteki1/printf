...
/* Functions to handle other params in the function. */
...
/*Function to print string when reversed*/
...
int ind, int length, int width, int flags, char padd, char extra_c,
int padd_start);

/* Utilities used in the functions */
